...
const ContentPetSitterTopLeft = () => {
  return (
    <div className="bg-gray-50  flex flex-col md:px-[80px] ">
      <div className="flex flex-col  py-[40px] px-[16px]  md:py-[24px] md:px-[80px] gap-[24px] md:gap-[48px]  max-w-[848px]">
        ...
        <div className="bg-white hidden md:flex flex-col justify-center  items-center w-full ">
      ...
      <div className="flex flex-col items-center">
        <div className="bg-white flex flex-col justify-center items-center w-full  md:hidden">
          <div className="flex flex-col items-center py-[40px] px-[24px] gap-[24px]">
            <img src={girl} className="w-[120px] max-w-[160px]"></img>
            <div className="flex flex-col gap-[16px] items-center">
              <h1 className="text-black text-[24px] leading-[32px] font-bold ]">
        ...
        <div className="flex flex-col gap-[24px] md:gap-[40px] p-[16px]">
          <div className="flex flex-col items-start gap-[16px] md:gap-[24px] p-[24px]">
            ...
            <div className="flex flex-col gap-[12px] w-full">
              ...
              <div className="flex flex-wrap gap-[8px]">
                <p className="bg-#FFF5EC text-primaryorange-500 border-primaryorange-500 border rounded-[8px] text-[16px] leading-[28px] w-[105px] h-[36px] pt-[4px] px-[12px]">
                  All Reviews
                </p>
                <p className="text-primarygray-400  border-primarygray-200 border rounded-[8px] text-[16px] leading-[28px] w-[142px] h-[36px] pt-[4px] px-[8px]">
                  5⭐⭐⭐⭐⭐
                </p>
                <p className="text-primarygray-400  border-primarygray-200 border rounded-[8px] text-[16px] leading-[28px] w-[120px] h-36px pt-[4px] px-[8px]">
                  4⭐⭐⭐⭐
                </p>
                <p className="text-primarygray-400  border-primarygray-200 border rounded-[8px] text-[16px] leading-[28px] w-[98px] h-[36px] pt-[4px] px-[8px]">
                  3⭐⭐⭐
                </p>
                <p className="text-primarygray-400  border-primarygray-200 border rounded-[8px] text-[16px] leading-[28px] w-[76px] h-[36px] pt-[4px] px-[8px]">
                  2⭐⭐
                </p>
                <p className="text-primarygray-400  border-primarygray-200 border rounded-[8px] text-[16px] leading-[28px] w-[54px] h-[36px] pt-[4px] px-[8px]">
                  1⭐
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-[16px] ">
            ...
            <div className="flex flex-col text-primarygray-500 text-[14px] leading-[24px] font-medium ">
              ...
              <p>
                ...
                care of my two energetic Labrador Retrievers, Max and Bella,
                while I was away on a business trip. I can confidently say that
                Jane exceeded all my expectations as a pet sitter.
              </p>
            </div>
          </div>
        </div>
