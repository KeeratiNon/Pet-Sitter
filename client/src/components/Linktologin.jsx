...
=======
      className="    p-0  md:p-[80px]  object-cover  bg-slate-500  "
    >
      <body className=" container bg-secondaryyellow-100 rounded-none w-[375px] h-[469px]  flex flex-col-reverse  relative md:rounded-[10px] md:w-[608px] lg:w-[864px] xl:w-[1280px] xl:h-[448px] ">
        <div className="  absolute w-[248px] h-[124px]  left-[-28px]  md:left-[0px] xl:w-[337px] xl:h-[168px]  ">
>>>>>>> 7e0dcd465fc2d599aa39b698fa9c2a79be7d34a9
...
=======
            Perdfect Pet Sitter <br /> <span>For Your Pet</span>
>>>>>>> 7e0dcd465fc2d599aa39b698fa9c2a79be7d34a9
          </h1>
...
=======
          <div className=" absolute w-[133.76px] h-[133.81px]  top-[-63.98px] left-[75.38px]  rotate-[-15.01deg] md:top-[-50px] xl:w-[229px] xl:h-[229px]  ">
>>>>>>> 7e0dcd465fc2d599aa39b698fa9c2a79be7d34a9
